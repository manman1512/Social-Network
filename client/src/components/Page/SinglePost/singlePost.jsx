...
export default function SinglePost({handleSetAuthor, handleSetId, handleSetTags}) {
  ...
  return (
    <div className="flex-auto my-4">
      {
        // Edit button
        state.user && post && post.author?._id === state.user._id && <button className="absolute p-4 rounded-full bg-lime-500 text-white right-4 top-16 flex items-center justify-center" onClick={()=>{
      ...
      <img src="https://picsum.photos/1140" alt="" className="w-full h-[168px] rounded-lg "  />
      </div>
      {post !== {} && (
        <div className=" bg-white mx-auto flex flex-col gap-y-4">
          ...
          <div className="flex gap-x-4 items-center">
            ...
            <div className="ml-auto">
              ...
              {
                post.createdAt !== post.updatedAt && <p className="text-sm italic text-gray-500">
